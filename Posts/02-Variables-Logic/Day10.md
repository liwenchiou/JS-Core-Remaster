...
【核心圖解重點】：
「變色龍盔甲 (this context)：畫面中心是一把帶有 this 指標的神劍。當 Hero.attack() 時，劍身散發黃光並指向 Hero 物件；當 Monster 奪走並發動時，劍身光芒瞬間轉向 Monster。畫面具備明確的『點 (.) 前面的執行者』與『this 歸屬』的連實線映射。」

【視覺場景】：
畫面呈現公會導師正手持神劍，不斷變換位置向驚訝的新手解釋「環境決定歸屬」的真相。背景是神聖的公會認證大廳。
強調：導師的表情是「引領新手看見真相」的溫柔與自信。

【視覺規範】：
- 風格：Excalidraw 手繪感。
- 配色守護：黃色 #FFD43B (發光指向)、藍色 #4DABF7 (結構框架)、紅色 #FA5252 (邏輯反應)。
-->
...
1.  [📜 本日實戰任務：變色龍盔甲判定實驗室 (CodePen)](https://codepen.io/editor/liwenchiou/pen/019d0a26-9ab3-747a-b6e8-c79c014cd865)
