...
> **導師的圖解心法：** `Class` 就是一張 **「怪物設計圖」**。你只需要定義一次「史萊姆長什麼樣子、會什麼技能」，接著你只需要呼叫 `new` 咒語，工廠生產線就會源源不絕地幫你把活生生的分身給捏出來。

<!-- 🎨 圖解提示詞 (導師專用，產後刪除) ：
忘掉你前面產出的圖，按照我以下的提示詞重新產生，這是一個公會導師正在教導新手冒險者的畫面：

【核心圖解重點】：
「史萊姆工廠 (Classes)：畫面中央是一張發光的藍色設計圖 (Blueprint)，上方標註著 Slime Class。生產線正源源不絕地從藍圖中產出三個外型一致、但名字與血量 (Instances) 稍有不同的小怪物。展現『一套模板、批量生產』的秩序美感。」

【視覺場景】：
畫面呈現公會導師正手持教鞭，指著發光的設計圖向專注的新手展示如何用制服（Class）來管理群體。背景是神祕且充滿秩序的公會工作坊。
強調：導師的表情是「引領新手看見真相」的溫柔與自信。

【視覺規範】：
- 風格：Excalidraw 手繪感。
- 配色守護：黃色 #FFD43B (生成的實體數據)、藍色 #4DABF7 (結構框架)。
-->
